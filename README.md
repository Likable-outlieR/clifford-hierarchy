This repository contains the code for Section 6 of the paper "Permutation gates in the third level of the Clifford hierarchy" by Zhiyang He, Luke Robitaille, and Xinyu Tan.
